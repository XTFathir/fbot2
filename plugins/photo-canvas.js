...
handler.help = ['wasted', 'glass', 'passed', 'jail', 'comrade / komunis', 'pixelate', 'blur', 'greyscale', 'invert', 'brightness', 'threshold', 'sepia', 'red']
handler.tags = ['canvas']
handler.command = /^wasted|glaass|passed|jail|comrade|komunis|pixelate|blur|greyscale|invert|brightness|threshold|sepia|red$/i
