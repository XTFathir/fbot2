...
`.trim(), author, [[user.banned ? 'Pemilik Bot' : 'Menu', user.banned ? '.owner' : '/menu']], m, {quoted:{key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: jpegThumbnail: Buffer.alloc(0)}}}})
    user.pc = new Date * 1
}
