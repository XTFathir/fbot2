...
conn.sendButton(m.chat, `Random *${command}*`, author, x.data.url, [['🔄 Next 🔄', '.mim ' + text1 + '|' + text2]], m, {quoted:{key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: m,jpegThumbnail: Buffer.alloc(0)}}}})
